...
int main()
{
    ...
    while (test == true)
    {
        ...
        //Giving user option to play again, allowing it to be played multiple times
        cout<<"Would you like to play again? Please input 'y' if yes and input 'n' if no."<<endl;
        cin>>testinput;
        if (testinput == "y")
        {
            test = true;
